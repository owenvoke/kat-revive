            ...
            if (strlen($query) < 2) {
				...
				<div class="container" style="margin-top: 5%;">
					<div class="alert alert-danger">
						...
						<p>Please enter a query with more than 2 characters.</p>
					</div>
				</div>
				<?php
                exit();
			...
			<div class="text-center">
				<form role="search" action="/search" method="get">
					<div class="form-group">
						<input name="q" type="text" class="form-control" placeholder="Search" value="<?php if (isset($_GET['q'])) {
    echo $_GET['q'];
} ?>">
					</div>
					<div class="form-group">
				...
				<nav>
					<ul class="pagination">
						<li>
							<a href="?s=<?php if ($startPoint > 20) {
    echo $startPoint - 20;
} else {
    echo '0';
} if (isset($_GET['q'])) {
    echo '&q='.urlencode($_GET['q']);
} if (isset($_GET['c'])) {
    echo '&c='.urlencode($_GET['c']);
}?>" aria-label="Previous">
						...
						<li>
							<a href="?s=<?php echo $startPoint + 20; if (isset($_GET['q'])) {
     echo '&q='.urlencode($_GET['q']);
 } if (isset($_GET['c'])) {
     echo '&c='.urlencode($_GET['c']);
 }?>" aria-label="Next">
